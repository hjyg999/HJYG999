 ...
 * 投资中
 */
public class BiddingActivity extends BaseListActivity implements
...
//	public String Method_name = "InvestApi/GetInvestingByPage";
	...
	public void CallMyInvestmentWebservice(String page) {

		dft.getBiddingDetails(page, Constants.GetInvest_URL, Request.Method.POST,
	...
	public void SetUIData(String Loadmore) {
		...
		if (Loadmore.isEmpty()) {
			...
			if (financial_details.List == null || financial_details.List.size() < 10) {
	...
	public void CallMyInvestmentWebservice_Loadmore(String page) {
