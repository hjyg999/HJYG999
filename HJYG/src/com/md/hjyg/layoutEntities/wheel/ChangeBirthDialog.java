...
//	private View vChangeBirthChild;
	...
	private int itemsConunt = 5;
	
	private boolean isShowYear = true,isShowMonth = true,isShowDay = true;
	 ...
	 */
	public void setStyle(boolean isShowYear,boolean isShowMonth,boolean isShowDay){
...
//		vChangeBirthChild.setOnClickListener(this);
	...
	public void initYears() {
		for (int i = getYear(); i >= getYear()-3; i--) {
			arry_years.add(i + "");
		}
	}
	...
	public void setTextviewSize(String curriteItemText, CalendarTextAdapter adapter) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (curriteItemText.equals(currentText)) {
				...
				textvew.setTextSize(minTextSize);
				textvew.setTextColor(context.getResources().getColor(R.color.gray));
			}
		}
	}
