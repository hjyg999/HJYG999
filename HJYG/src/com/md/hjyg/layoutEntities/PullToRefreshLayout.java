...
/**
 * ClassName: PullToRefreshLayout date: 2016-3-4 上午10:40:42
 * remark:自定义的布局，用来管理三个子控件
	...
	public void refreshFinish(int refreshResult) {
		...
		case SUCCEED:
			...
			refreshStateImageView
					.setBackgroundResource(R.drawable.gold_greenyes);
			break;
		case FAIL:
		default:
			// 刷新失败
			...
			refreshStateImageView.setBackgroundResource(R.drawable.delete_28);
			break;
		}
		if (pullDownY > 0) {
			// 刷新结果停留1秒
...
//			loadStateImageView.setBackgroundResource(R.drawable.gold_greenyes);
			break;
		case FAIL:
		default:
			// 加载失败
...
//			loadStateImageView.setBackgroundResource(R.drawable.delete_28);
			break;
		}
		if (pullUpY < 0) {
